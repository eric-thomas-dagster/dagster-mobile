  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        ...
        {/* Performance Metrics - Show skeleton or data */}
        {creditsLoading || execLoading || retriesLoading || checkErrorsLoading ? (
          <Card style={[styles.card, { backgroundColor: theme.colors.surface }]}>
            <MetricsSkeleton />
          </Card>
        ...
        {/* Hourly Breakdown Charts - Show skeleton or data */}
        {matLoading || failLoading ? (
          <>
            <ChartSkeleton />
            <ChartSkeleton />
        ...
        {/* Asset Breakdown - Show skeleton or data */}
        {assetsMatLoading || assetsFailLoading || assetsCreditsLoading ? (
          <>
            <AssetListSkeleton />
            <AssetListSkeleton />
          </>
